namespace SibaDev.Models
{
    ...
    [Table("DEVSIBAINS.MS_UDW_POLICY_HEAD")]
    public partial class MS_UDW_POLICY_HEAD:Model
    {
        [Key]
        ...
        [Required]
        [StringLength(40)]
        public string POLH_DOC_NO { get; set; }

        [StringLength(40)]
        public string POLH_END_NO { get; set; }

        [StringLength(40)]
        public string POLH_QUT_SER_NO { get; set; }

        [StringLength(40)]
        public string POLH_POL_SER_NO { get; set; }
        ...
        [StringLength(15)]
        public string POLH_COMP_CODE { get; set; }
