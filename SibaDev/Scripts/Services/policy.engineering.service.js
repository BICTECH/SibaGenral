(function (s, u) {
    s.add({
        save_bond: function (bonds, success, error) {
            u.post("/api/policybond/save", bonds, success, error);
        },
        get_bonds: function (success, error) {
        ...
        get_lov_insurance_source: function (success, error) {
        ...
        check_broker_agent_code: function (code, success, error) {
            u.get("/api/SourceBusiness/check/" + code, success, error);
        },
