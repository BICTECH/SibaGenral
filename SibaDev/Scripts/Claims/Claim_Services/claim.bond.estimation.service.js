(function (s, u) {
    s.add({
        save_estimation: function (estimations, success, error) {
            u.post("/api/ClaimEstimationBond/save", estimations, success, error);
        },
        get_estimations: function (success, error) {
            u.get("/api/ClaimEstimationBond", success, error);
        },
        search_estimation: function (query, success, error) {
            u.get("/api/ClaimEstimationBond/search/" + query, success, error);
        },
        search_policys_est: function (query, success, error) {
            u.get("/api/policybond/searchest/" + query, success, error);
        },
        get_policys_est: function (success, error) {
            u.get("/api/policybond", success, error);
        },     
        get_polh_lov: function (success, error) {
            u.get("/api/policybond/lov", success, error);
        },
        getRisksLOV: function (data, success, error) {
            u.post("/api/policybond/clmrisk", data, success, error);
        },
