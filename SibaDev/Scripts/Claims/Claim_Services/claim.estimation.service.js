(function (s, u) {
    s.add({
        ...
        search_estimation: function (query, success, error) {
            u.get("/api/ClaimEstimation/search/" + query, success, error);
        },
        search_policys_est: function (query, success, error) {
            u.get("/api/policymotor/searchest/" + query, success, error);
        },
        ...
        getRisksLOV: function (data, success, error) {
            u.post("/api/policymotor/clmrisk", data, success, error);
        },
